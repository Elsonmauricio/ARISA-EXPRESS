          ...
          {user ? (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 text-sm text-gray-700 hover:text-gold transition-colors group"
              >
         ...
         {open && (
          ...
          >
            ...
            {user ? (
              ...
              <>
                <Link to="/login" onClick={() => setOpen(false)} className="text-gray-700 hover:text-gold transition-colors">
                  {t('nav.entrar')}
                </Link>
