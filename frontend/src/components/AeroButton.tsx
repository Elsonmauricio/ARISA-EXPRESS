...
export function AeroButton({
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className={`aero-chamfer inline-flex items-center gap-2 sm:gap-3 px-5 sm:px-7 py-3 sm:py-3.5 font-data text-[#1a1133] sm:text-[13px] font-bold uppercase tracking-wider transition-all duration-300 ${variantClasses} ${className}`}
    >
