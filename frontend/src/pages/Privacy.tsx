      ...
      <div className="min-h-screen bg-black pt-28 pb-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="glass-strong border-gradient p-8 rounded-2xl text-white/80 space-y-6">
            ...
            <h2 className="text-xl font-semibold text-white">{t('privacy.s1')}</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-white">{t('privacy.s2')}</h2>
            ...
            <h2 className="text-xl font-semibold text-white">{t('privacy.s3')}</h2>
            ...
            <h2 className="text-xl font-semibold text-white">{t('privacy.s4')}</h2>
            <p>
              <strong>{t('privacy.s4t1')}</strong><br />
              {t('privacy.s4t2')}
            </p>

            <h2 className="text-xl font-semibold text-white">{t('privacy.s5')}</h2>
            <p>{t('privacy.s5text')}</p>

            <h2 className="text-xl font-semibold text-white">{t('privacy.s6')}</h2>
            ...
            <h2 className="text-xl font-semibold text-white">{t('privacy.s7')}</h2>
            <p>{t('privacy.s7text')}</p>

            <h2 className="text-xl font-semibold text-white">{t('privacy.s8')}</h2>
            <p>{t('privacy.s8text')}</p>

            <h2 className="text-xl font-semibold text-white">{t('privacy.s9')}</h2>
