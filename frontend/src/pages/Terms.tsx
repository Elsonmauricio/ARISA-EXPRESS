      ...
      <div className="min-h-screen bg-[#D8B9FF] pt-28 pb-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="glass-strong border-gradient p-8 rounded-2xl text-gold/80 space-y-6">
            <p className="text-sm text-gold/60">{t('terms.atualizado', { date: new Date().toLocaleDateString('pt-PT', { month: 'long', year: 'numeric' }) })}</p>
            ...
            <p className="text-sm text-gold/60">{t('terms.s5nota')}</p>
