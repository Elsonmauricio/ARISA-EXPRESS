      ...
      <div className="min-h-screen bg-black pt-28 pb-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="glass-strong border-gradient p-8 rounded-2xl text-white/80 space-y-6">
            ...
            <h2 className="text-xl font-semibold text-white">{t('terms.s1')}</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-white">{t('terms.s2')}</h2>
            <p>{t('terms.s2text')}</p>
            ...
            <h2 className="text-xl font-semibold text-white">{t('terms.s3')}</h2>
            <p>{t('terms.s3text')}</p>
            <ul className="list-disc pl-6 space-y-1">
              <li>{t('terms.pag1')}</li>
              <li>{t('terms.pag2')}</li>
            ...
            <h2 className="text-xl font-semibold text-white">{t('terms.s4')}</h2>
            <p>{t('terms.s4text')}</p>

            <h2 className="text-xl font-semibold text-white">{t('terms.s5')}</h2>
            <ul className="list-disc pl-6 space-y-1">
              <li>{t('terms.s5t1')}</li>
              <li>{t('terms.s5t2')}</li>
            </ul>
            ...
            <h2 className="text-xl font-semibold text-white">{t('terms.s6')}</h2>
            <p>{t('terms.s6text')}</p>
            <ul className="list-disc pl-6 space-y-1">
              <li>{t('terms.r1')}</li>
              <li>{t('terms.r2')}</li>
            ...
            <h2 className="text-xl font-semibold text-white">{t('terms.s7')}</h2>
            <p>{t('terms.s7t1')}</p>
            <p>{t('terms.s7t2')}</p>
          </div>
        </div>
